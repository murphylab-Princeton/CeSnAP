function Layout = plotFiguresThreshhold(Layout, info, filePD, ResultPD)
                    ...
                    tmpNearCurl{aa}(bb)    = 0;
                     ...
                     for SnapID = 1:length(filePD(CaseID).worms{RoundID})
                            for k  = 1:length(filePD(CaseID).worms{RoundID}{SnapID}.worm_bc)
                                        if ResultPD.CurlCrit{CaseID}{RoundID}{SnapID}{k}==1,         tmpCurl{aa}(bb)        = tmpCurl{aa}(bb)     +1;         end
                                        if ResultPD.CurlCrit{CaseID}{RoundID}{SnapID}{k}~=2,         tmpTotal{aa}(bb)       = tmpTotal{aa}(bb)    +1;         end
                                        if ResultPD.tagNearCurlState{CaseID}{RoundID}{SnapID}{k}==1, tmpNearCurl{aa}(bb)    = tmpNearCurl{aa}(bb) +1;         end
                            end
                     end
                     end
                     end
